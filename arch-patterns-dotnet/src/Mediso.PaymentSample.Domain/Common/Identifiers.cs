...
public readonly record struct PaymentId
{
    ...
    {
        _value = value != Guid.Empty ? value : throw new DomainException("PaymentId cannot be empty");
    }
    ...
    public static PaymentId Parse(string id)
    {
        ...
        throw new DomainException("Invalid PaymentId format");
    }
}
...
public readonly record struct ReservationId
{
    ...
    {
        _value = value != Guid.Empty ? value : throw new DomainException("ReservationId cannot be empty");
    }
...
public readonly record struct LedgerEntryId
{
    ...
    {
        _value = value != Guid.Empty ? value : throw new DomainException("LedgerEntryId cannot be empty");
    }
...
/// <summary>
/// CustomerId using readonly record struct for optimal performance
/// </summary>
public readonly record struct CustomerId
{
    ...
    /// <summary>
    /// Creates a new CustomerId with validation
    /// </summary>
    /// <param name="value">GUID value for the customer ID</param>
    /// <exception cref="DomainException">Thrown when value is empty</exception>
    public CustomerId(Guid value)
    {
        _value = value != Guid.Empty ? value : throw new DomainException("CustomerId cannot be empty");
    }
    ...
    /// <summary>
    /// Creates CustomerId from Guid
    /// </summary>
    public static implicit operator CustomerId(Guid value) => new(value);
}

/// <summary>
/// MerchantId using readonly record struct for optimal performance
/// </summary>
public readonly record struct MerchantId
{
    ...
    /// <summary>
    /// Creates a new MerchantId with validation
    /// </summary>
    /// <param name="value">GUID value for the merchant ID</param>
    /// <exception cref="DomainException">Thrown when value is empty</exception>
    public MerchantId(Guid value)
    {
        _value = value != Guid.Empty ? value : throw new DomainException("MerchantId cannot be empty");
    }
    ...
    /// <summary>
    /// Creates a new MerchantId with a generated GUID
    /// </summary>
    ...
    /// Implicit conversion to Guid for compatibility
    /// </summary>
    public static implicit operator Guid(MerchantId id) => id._value;

    /// <summary>
    /// Creates MerchantId from Guid
    /// </summary>
